<?php 
    $lista = [
        ...
        [
            //secondo livello: chiavi letterali
...
<html lang="en">
    ...
    <header class="container-fluid fixed-top">
        <div class="wrapper d-flex justify-content-between align-items-center">
            <div class="logo">
                <a href="#">
                    <img src="img/unnamed.png" alt="Logo Google">
                    <span>Privacy e Termini</span>
                </a>
            </div>
            <div class="account">ICONE ACCOUNT</div>
        </div>
        <nav>NAV BAR</nav>
    </header>
    <!-- /Header -->

    <!-- Main - Domande risposte -->
    <main>
        <div id="main">
    ...
    <footer>
        <div id="footer">
            <div class="d-flex justify-content-between align-items-center h-100">
                ...
                <div class="lingua">
                    <select class="w-10" aria-label="Default select example">
